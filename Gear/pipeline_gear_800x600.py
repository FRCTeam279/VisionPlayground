...
class ContourPipeline:
    ...
    def __init__(self):
        ...
        self.__resize_image_width = 800.0
        self.__resize_image_height = 600.0
        self.__resize_image_interpolation = cv2.INTER_CUBIC

        self.resize_image_output = None

        self.__hsv_threshold_input = self.resize_image_output
        self.__hsv_threshold_hue = [53.0, 80.0]
        ...
        self.__filter_contours_min_width = 20
        self.__filter_contours_max_width = 600
        self.__filter_contours_min_height = 20
        self.__filter_contours_max_height = 600
